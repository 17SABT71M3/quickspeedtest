...
if %errors%==3 title no go &cls & echo Open This Batch File in Notepad ^& Edit the Path to the Correct OOKLA exe & PAUSE >NUl
if %errors%==9009 title no go & cls & echo Open This Batch File in Notepad ^& Edit the Path to the Correct OOKLA exe & PAUSE >NUl
REM :skip
